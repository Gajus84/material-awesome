...
local app = require('configuration.apps').default.quake_player
...
local create_quake = function()
	-- Check if there's already an instance of 'QuakePlayer'.
	-- If yes, recover it - use it again.
	local quake_player = function (c)
		return ruled.client.match(c, {instance = 'QuakePlayer'})
	end
	for c in awful.client.iterate(quake_player) do
		-- 'QuakePlayer' instance detected
	...
	-- No 'QuakePlayer' instance, spawn one
